...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of mermer', () => {
      const result = units.getUnit('mermer');
    ...
    it('gets unit of mermer using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of mermer', () => {
      const result = units.getDisplay('mermer');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('mermer', 9);

      const result = units.getUnit('mermer');

      expect(result).toEqual(9);

      units.setUnit('mermer', 1);
    });
  });
  describe('#setDisplay', () => {

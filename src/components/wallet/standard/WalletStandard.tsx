...
import { /* mojo_to_mermer_string, */ mermer_to_mojo } from '../../../util/mermer';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_mermer_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of mermer in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Mermer that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Mermer that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send mermer to coloured address. Please enter a mermer
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'mermer_addr://') {
    ...
    const amountValue = Number.parseFloat(mermer_to_mojo(amount));
    const feeValue = Number.parseFloat(mermer_to_mojo(fee));

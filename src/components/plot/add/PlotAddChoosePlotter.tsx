...
import { CardStep, Select } from '@mermer/core';
import {
  FormControl,
  FormHelperText,
  Grid,
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort mermerpos to the top of the list
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Mermer Proof of Space plotter. If unsure,
            use the default Mermer Proof of Space plotter.
        </Trans>
      </Typography>

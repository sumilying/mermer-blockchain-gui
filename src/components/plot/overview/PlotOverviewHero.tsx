...
import { CardHero, Flex, Link } from '@mermer/core';
import { PlotHero as PlotHeroIcon } from '@mermer/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Mermer. '
              }
              <Link
                target="_blank"
                href="https://github.com/Mermer-Network/mermer-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>

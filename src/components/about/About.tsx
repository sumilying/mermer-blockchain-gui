...
import icon from '../../assets/img/mermer_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Mermer Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Mermer-Network/mermer-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>

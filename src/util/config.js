...
global.daemon_rpc_ws = `wss://${self_hostname}:88400`;//55400
  ...
  try {
    ...
    const config_root_dir =
      'CHIA_ROOT' in process.env
        ...
        : path.join(os.homedir(), '.mermer', net);
    ...
    const daemon_port = lodash.get(config, 'ui.daemon_port', 88400); // jshint ignore:line//55400
